        ...
        <el-tab-pane :label="currentData.children[1].name" name="second">
          ...
          <div class="text_bottom">
            ...
            <div class="text_bottom_right">
              ...
              <div>
                <el-carousel :interval="5000" arrow="always">
                  <el-carousel-item v-for="(item,index) in currentData.children[1].recommend_orgs" :key="index">
        ...
        <el-tab-pane :label="currentData.children[2].name" name="third">
          ...
          <div class="text_bottom">
            ...
            <div class="text_bottom_right">
              ...
              <div>
                <el-carousel :interval="5000" arrow="always">
                  <el-carousel-item v-for="(item,index) in currentData.children[2].recommend_orgs" :key="index">
                    <img :src="item.logo" alt id="samll_img" />
                  </el-carousel-item>
                </el-carousel>
              </div>
...
export default {
  ...
  mounted() {
    this.$root.bus.$on("content6", this.getCurrentProvince);
  },
  methods: {
    handleClick(node) {
