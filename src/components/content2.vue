  ...
  created() {
    fetch(`/api/index/contents`, {
      ...
      .then(res => {
        ...
        this.titelName = arr[2].name;
        this.childrenName=arr[2].children[0].name
        this.childrenName1=arr[2].children[1].name
        this.childrenName2=arr[2].children[2].name
        this.childrenName3=arr[2].children[3].name
        this.childrenName4=arr[2].children[4].name
        this.childrenName5=arr[2].children[5].name
        this.imgUrl=arr[2].pc_img;
        this.items=arr[2].children[0].courses;
        this.items1=arr[2].children[1].courses;
        this.items2=arr[2].children[2].courses;
        this.items3=arr[2].children[3].courses;
        this.items4=arr[2].children[4].courses;
        this.items5=arr[2].children[5].courses;
        this.contents=arr[2].children[0].articles
        this.contents1=arr[2].children[1].articles
        this.contents2=arr[2].children[2].articles
        this.contents3=arr[2].children[3].articles
        this.contents4=arr[2].children[4].articles 
        this.contents5=arr[2].children[5].articles 
      });
  },
   methods: {
